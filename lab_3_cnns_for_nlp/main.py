...
#doc_wv = Embedding(input_dim = len(index_to_word), output_dim = d, input_length = max_size)(doc_ints)
doc_wv = Embedding(input_dim = max(word_to_index.values()) + 1, output_dim = d, input_length = max_size)(doc_ints)
...
#get_region_embedding = K.function()
